...
signal_output_weight2 = signal_output_quantile[['turn_annual_resp','win_rate_sp','pc_ratio_sp']].loc[0.5].loc['win_rate_sp'] < signal_output['win_rate_sp']
...
# 选出Top1 
# 计算上期method
signal_output['Max_method'].nlargest(3, asix = 0 ,keep = 'all')
