...
df2 = signal_output[(signal_input['model'] == signal_output['model']) & (signal_input['start_date'] == signal_output['start_date'])]
signal_output['signal'] = df1.dot(df2[['annual_return_sp','win_rate_sp','pc_ratio_sp']])

# signal_output
signal_output.to_excel('/Users/dylan/DataBase/signal_process/1.xlsx')
signal_input.to_excel('/Users/dylan/DataBase/signal_process/2.xlsx')
