...
def get_weight_group(x,method) :
    if x < df_quantile[method].loc[0.25].loc[method]: 
        return 1
    elif df_quantile[method].loc[0.25].loc[method] < x < df_quantile[method].loc[0.5].loc[method]: 
        return 2 
    elif df_quantile[method].loc[0.5].loc[method] < x < df_quantile[method].loc[0.75].loc[method] : 
        return 3         
    else : 
        return 4 
